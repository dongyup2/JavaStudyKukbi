...
public class Main {
	...
	public static void main(String[] args) {
		...
		Map<String, Object> todoMap1 = new HashMap<String, Object>();//todoMap1 한묶음
		todoMap1.put("code", 182);
		todoMap1.put("message", "스프링 부트 서버 테이스_182");
		todoMap1.put("todoComplete", true);
		todoMap1.put("importance", false);
		todoMap1.put("totalCount", 157);
		todoMap1.put("incompleteCount", 78);
		
		Map<String, Object> todoMap2 = new HashMap<String, Object>();//todoMap2 한묶음
		todoMap2.put("code", 181);
		todoMap2.put("message", "스프링 부트 서버 테이스_181");
		todoMap2.put("todoComplete", true);
		todoMap2.put("importance", false);
		todoMap2.put("totalCount", 157);
		todoMap2.put("incompleteCount", 78);
		
		list.add(todoMap1); // 0번 인덱스에 들어있다
		list.add(todoMap2); // 1번 인덱스에 들어있다
